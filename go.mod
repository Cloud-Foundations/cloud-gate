module github.com/Cloud-Foundations/cloud-gate
...
require (
	...
	github.com/Cloud-Foundations/keymaster v1.11.0
...
require (
	...
	github.com/getlantern/golog v0.0.0-20221005122140-90163e7271a3 // indirect
